...
public class ResourceInfo  implements java.io.Serializable{
	...
	private Set<ResourceInfo> childResources = new HashSet<ResourceInfo>();
	...
	public Set<ResourceInfo> gotChildResources() {
		return childResources;
	}

	public void setChildResources(Set<ResourceInfo> childResources) {
