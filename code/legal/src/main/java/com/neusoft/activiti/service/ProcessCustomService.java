...
import com.neusoft.activiti.service.impl.TaskServiceImpl;
...
public class ProcessCustomService {
	...
	public ProcessDefinitionEntity findProcessDefinitionEntityByProcessDefinitionId(
	...
	public void turnTransition(String taskId, String activityId,
		...
		try {
			...
			taskServiceImpl.supComplete(taskId, variables);
		} catch (Exception e) {
			// 
	...
	public InputStream getImageStream(String taskId) throws Exception {
		 ...
		 * runtimeService.
		 * getActiveActivityIds(findProcessInstanceByTaskId(taskId).getId()));
		 * return imageStream;
		 */
		return null;
	}
