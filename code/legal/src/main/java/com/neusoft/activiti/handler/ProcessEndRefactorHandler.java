 ...
 *约定目录为
 */
public class ProcessEndRefactorHandler extends AbstractBpmnParseHandler<EndEvent> {
	...
	protected void executeParse(BpmnParse bpmnParse, EndEvent element) {
		...
		bpmnParse.getCurrentActivity().addExecutionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, taskListener);
	}
