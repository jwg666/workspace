...
<div class="main">
  <div class="big">
    <div class="retrievePasswordBgWrap">
      <div class="retrievePasswordtopBG"><span>修改密码</span></div>
      <div class="mbg">
        <div class="retrievePassword">
          ...
          <div class="form"> 
            ...
            <s:form action="retrieveUpdatePassword" namespace="/security" method="post" id="retrievepasswordForm">
              ...
              <s:textfield name="name"  cssClass="input"/>
              </div>
              <div class="user"> <span class="text">新密码：</span>
                <s:password name="password"  cssClass="input"/>
              </div>
              <div class="user"> <span class="text">确认密码：</span>
