	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [ [ 
			   ...
			   {field:'caseId',title:'caseId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'approveId',title:'approveId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'approveContent',title:'approveContent',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'approveTime',title:'approveTime',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'datetimebox',
							options : {}
					},
			   ...
			   {field:'workTime',title:'workTime',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'datetimebox',
							options : {}
					},
