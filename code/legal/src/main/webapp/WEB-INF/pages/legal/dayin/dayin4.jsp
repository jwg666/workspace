...
<div class="gh_zw">
  ...
  <input name="" type="text" class="gh_input" size="10"/></span>年
  <span class="bbf" style="width: 40px;display：inline;">
  <input name="" type="text" class="gh_input" size="7"/>
  </span>月
  <span class="bbf" style="width: 40px;display：inline;">
  <input name="" type="text" class="gh_input" size="7"/>
  </span>日向本中心提出的
  <span class="bbf" style="width: 140px;display：inline;">
  <input name="" type="text" class="gh_input" size="30"/></span>一案法律援助申请，经审查，符合法律援助条件，现决定给予法律援助，提供法律援助的方式为
  <span class="bbf" style="width: 140px;display：inline;">
