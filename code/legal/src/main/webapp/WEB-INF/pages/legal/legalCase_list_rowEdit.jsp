	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [ [ 
			   ...
			   {field:'applicantId',title:'applicantId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'reasonId',title:'reasonId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'signiturePath',title:'signiturePath',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'caseFrom',title:'caseFrom',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'applyDate',title:'applyDate',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'datetimebox',
							options : {}
					},
			   ...
			   {field:'applyTypeId',title:'applyTypeId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'applyTypeProcess',title:'applyTypeProcess',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
