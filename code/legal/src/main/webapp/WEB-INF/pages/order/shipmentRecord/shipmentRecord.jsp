...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
			...
			buttons : [ {
				...
				handler : function() {
					...
					showSpecialCntItemForm.form('submit',{
						url : '${dynamicURL}/shipmentRecord/shipmentRecordAction!importshipment.do',
	  ...
	  //加载国家信息
		...
		datagrid = $('#datagrid').datagrid({
			url : '${dynamicURL}/shipmentRecord/shipmentRecordAction!datagrid1.do',
			title : '出运计划备案表列表',
			iconCls : 'icon-save',
			pagination : true,
			pagePosition : 'bottom',
	...
	function save(){
			...
			$.ajax({
				url:'${dynamicURL}/shipmentRecord/shipmentRecordAction!updateweis.action',
				type:'post',
				data:{
					shipmentList:shipmentList
				},
	...
	function daochu(){
		var url='${dynamicURL}/shipmentRecord/shipmentRecordAction!exportShipmentRecord.do';
