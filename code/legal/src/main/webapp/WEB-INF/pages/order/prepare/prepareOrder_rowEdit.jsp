...
<%@ page import="com.haier.openplatform.security.LoginContextHolder"%>
...
<body class="easyui-layout">
	<div region="north" border="false" title="搜索条件"
		...
		<form id="searchForm">
			<table>
				<tr>
					<td>查询字段<input name="cname" style="width: 100px;" />&nbsp;
					</td>
					<td>创建时间<input name="ccreatedatetimeStart"
						class="easyui-datetimebox" editable="false" style="width: 100px;" />至<input
						name="ccreatedatetimeEnd" class="easyui-datetimebox"
						editable="false" style="width: 100px;" /></td>
					<td>最后修改时间</td>
					<td><input name="cmodifydatetimeStart"
						class="easyui-datetimebox" editable="false" style="width: 100px;" />至<input
						name="cmodifydatetimeEnd" class="easyui-datetimebox"
						editable="false" style="width: 100px;" /><a
