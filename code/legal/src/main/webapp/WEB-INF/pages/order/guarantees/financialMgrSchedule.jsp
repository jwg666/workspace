...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid(
				{
					url : 'guaranteesAction!financialScheduleList.action?definitionKey=financeManagerCheck&dataSharing=86',
					title : '待办事项列表',
					pagination : true,
					pagePosition : 'bottom',
					rownumbers : true,
					...
					toolbar : [ {
						...
						handler : function() {
							...
							if (rows.length == 1) {
								...
								$.messager.alert('提示', '请选择一条保函记录', 'error');
							}
						}
					}, '-', {
						text : '申领',
		...
		datagridHistory = $('#datagridHistory').datagrid({
			url : 'guaranteesAction!orderMgrHistory.action?definitionKey=financeManagerCheck&dataSharing=86&taskType=my',
			title : '保函维护列表',
			pagination : true,
			pagePosition : 'bottom',
			rownumbers : true,
						...
						<form id="searchForm">
							...
							<div class="oneline">
								<div class="item25">
									...
									<div class="righttext">
										<span><input name="cycleFlag" type="text"
											class="short50" /></span>
									</div>
								</div>
								<div class="item25">
