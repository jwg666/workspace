...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid(
				{
					url : 'guaranteesAction!orderMgrSchedule.action?definitionKey=orderMangerCheck&dataSharing=50',
					title : '待办事项列表',
					pagination : true,
					pagePosition : 'bottom',
					rownumbers : true,
		...
		datagridHistory = $('#datagridHistory').datagrid({
			url : 'guaranteesAction!orderMgrHistory.action?definitionKey=orderMangerCheck&dataSharing=50',
			title : '保函维护列表',
			pagination : true,
			pagePosition : 'bottom',
			rownumbers : true,
	...
	function applyTasks() {
		...
		var taskIds = '';
		if (rows.length < 1) {
			$.messager.alert('提示', '请选择一条保函记录', 'info');
		} else {
						...
						<form id="searchFormHistory">
							...
							<div class="oneline">
								...
								<div class="item25">
									...
									<div class="righttext">
										<select class="easyui-combobox" name="currency"
											id="currencySearch0" style="width: 100px;"></select>
									</div>
								</div>
							</div>
							<div class="oneline">
