...
var printFlag=true;
 $(function() {
	 ...
	 datagrid_bookOrderItem= $('#datagrid_bookOrderItem').datagrid({
	    url : '${dynamicURL}/custorder/custOrderAction!searchDetail.do',
	    queryParams : {
			bookCode:bookCode
		},
		iconCls : 'icon-save',
		...
		onLoadSuccess: function(rowsData){
			 var orderCode="";
			 var bookCode=$("#bookCode").val();
			 var rows = datagrid_bookOrderItem.datagrid('getRows');
			 if(rows.length>0){
				 orderCode=rows[0].marks;
			 }
			 $("#orderCodeId").val(orderCode);
			 findShipPaperCode(orderCode);
			 $.ajax({
...
//获取抬头
 function findShipPaperCode(orderCode){
...
//查询
function _search() {
	datagrid_bookOrderItem.datagrid('load', sy.serializeObject(searchForm));
}
//套打
function appletPrint(){
	...
	if($("#bookCode").val().indexOf("-")>=0){
		...
		window.open("http://hrois.haier.net/report/Report-Guage.do?reportId=ff41cc19-e8ca-4f9c-95f9-7996e06ba164&silent=yes&isResultant=false&book_code="+$("#bookCode").val()+"&falg=01");
	}
	//window.open("http://hrois.haier.net/report/unieap/pages/report/jsp/show/Print.jsp?reportId=ff41cc19-e8ca-4f9c-95f9-7996e06ba164&silent=yes&isResultant=false&book_code="+$("#bookCode").val());
}
</script>
</head>
<body class="easyui-layout zoc">
	...
	<div region="center" border="false" class="zoc" title="" collapsed="false"  style="height: 600px;overflow: auto;" align="center" id="printBody">
		...
		<table id="tableHeader" style="border-collapse:collapse; width: 100%;">
			...
			<tr>
			    <td colspan="3"  align="center" style="height:70px;font-size:30px">INVOICE</td>
			</tr>
			<tr>
			  <td colspan="3">
				    <table style="border-style: solid ;border-width:0px;width:100%;border-collapse:collapse;">
						...
						<tr>
						     <th align="right">SHIP PER S.S:</th>
						     <td align="left"  >
						...
						<tr>
						      ...
						      <th align="right" colspan="2" >FOR ACCOUNTAND RISK OF MESSRS.</th>
						      <td colspan="4" align="left">
						         <input name="customerName" type="text" readonly="readonly" class="zoc" style="width:400px"></input>
						      </td>
						</tr>
						<tr>
							 <th align="right" colspan="5">DEAL TYPE:</th>
						     <td align="left"  >
			...
			<div id="custInvoiceAddDialog" style="display: none;width: 800px;height: 200px;overFlow-x: hidden;" align="center">
		<form id="custInvoiceAddForm" method="post">
			<div class="part_zoc zoc">
						...
						<div class="oneline">
							...
							<div class="righttext">
								<input name="unit" type="text" class="easyui-validatebox" data-options="required:true" missingMessage="请填写单位"  style="width: 155px;"/>						
							</div>
							<div class="itemleft60">订舱号:</div>
							<div class="righttext">
	...
	<div id="showLoadExcelDialog"
		style="display: none; width: 440px; height: 150px;" align="center">
