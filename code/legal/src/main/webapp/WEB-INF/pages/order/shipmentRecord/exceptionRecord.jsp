...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid(
				{
					url : '${dynamicURL}/shipmentRecord/shipmentRecordAction!datagrid0.do?statusFlag=4',
					title : '异常信息列表',
					iconCls : 'icon-save',
					pagination : true,
					pagePosition : 'bottom',
	...
	function exportExcel() {
		$("#searchForm").attr("action", "shipmentRecordAction!exportException.action");
		$("#searchForm").submit();
	}
	//重做，退回到未备案
	function rollBack() {
