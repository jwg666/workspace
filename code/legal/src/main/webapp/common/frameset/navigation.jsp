...
<div class="col-2">
	<ul>
		...
		<li><a href="${dynamicURL}/common/frameset/left.jsp?namespace=security" target="frame-left">安全控制</a></li>
		<li><a href="${dynamicURL}/common/frameset/left.jsp?namespace=basic" target="frame-left">基础数据</a></li>
	</ul>
</div>
